...
function Skills() {
  return (
    <section id="skills" className="min-h-screen min-h-dvh flex flex-col justify-center items-center p-4 md:p-16 lg:px-28">
      ...
      <div className="flex flex-col md:flex-row gap-5 md:gap-10 justify-center px-2 md:px-10">
        <article className="p-6 md:p-12 border-2 rounded-2xl w-[500px]">
        ...
        <article className="p-6 md:p-12 border-2 rounded-2xl max-w-screen-sm md:w-[500px]">
          <h3 className="text-lg md:text-xl lg:text-2xl font-medium">
            Front-End Developer
          </h3>
          <p className="text-xs md:text-sm lg:text-xl font-normal">
